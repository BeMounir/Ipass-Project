...
public class CustomerTest {
    ...
    public void testGetAllCustomersWithExistingCustomers() {
        ...
        List<Customer> customers = List.of(
                new Customer(1, "Testnaam1", "Test1@email.com", "123 straat"),
                new Customer(2, "Testnaam2", "Test1@email.com", "456 straat")
        );
    ...
    public void testCreateValidCustomer() {
        ...
        Customer customer = new Customer(1, "John Doe", "johndoe@example.com", "123 Main St");
    ...
    public void testCreateInvalidCustomer() {
        ...
        Customer invalidCustomer = new Customer(1, "", "email", "123 straat");
    ...
    public void testIsValidWithValidCustomer() {
        Customer validCustomer = new Customer(1, "John Doe", "johndoe@example.com", "123 Main St");
    ...
    public void testIsValidWithInvalidCustomer() {
        Customer invalidCustomer = new Customer(1, "", "testemail", "123 straat");
